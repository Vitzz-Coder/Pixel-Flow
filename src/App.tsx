...
const Layout = ({ children }: { children: React.ReactNode }) => (
  <SidebarProvider>
    <div className="flex h-screen w-screen overflow-hidden bg-[#0B0F17] max-w-full w-full overflow-x-hidden">
      ...
      <AppSidebar />
      <main className="flex-1 min-w-0 h-full overflow-y-auto overflow-x-hidden p-4 md:p-6 relative z-10">
